...
<li class="nav-item">
      <!-- Nav Item - Login -->
      <a class="collapse-item nav-link" href="{{ route('logout') }}" 
                                       onclick="var cek = confirm('{{auth::user()->name }} Ingin Logout?'); event.preventDefault();
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Agni-Maram-Olvy &copy; Project  </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
