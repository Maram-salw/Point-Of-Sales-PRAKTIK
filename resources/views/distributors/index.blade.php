...
@csrf
@method('DELETE')
<button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin, ingin menghapus {{$distributor->nama_distributor}}?')">Delete</button>
</form>
</td>
</tr>
@endforeach
