...
<input type="string" name="nama_rayon" value="{{ $rayon->nama_rayon }}" class="form-control" placeholder="Nama Rayon">
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
...
<div class="form-group">
<strong>No.Hp:</strong>
<input type="number" min='0' maxlength='13' name="no_hp" value="{{ $rayon->no_hp }}" class="form-control" placeholder="No.Hp">
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
